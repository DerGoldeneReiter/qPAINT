...
dir_name=[r'E:\Projects\qPAINT\data\18-01-30_OwnSimulation_4ds\12frames']*4+\
[r'E:\Projects\qPAINT\data\18-01-30_OwnSimulation_4ds\100frames']*4+\
...
axarr[0].plot(tau_ds[pltrange],tau_ds[pltrange]/4,color='black')
axarr[0].legend()
# 100 frames
pltrange=range(4,8)
...
axarr[1].plot(tau_ds[pltrange],tau_ds[pltrange]/4,color='black')
axarr[1].legend()
...
axarr[0].plot(concs[pltrange]*1e9,4*np.divide(NoFrames[0],tau_bs[pltrange]+tau_ds[pltrange]),color='black')
axarr[0].legend()
# 100 frames
pltrange=range(4,8)
...
axarr[1].plot(concs[pltrange]*1e9,4*np.divide(NoFrames[0],tau_bs[pltrange]+tau_ds[pltrange]),color='black')
axarr[1].legend()