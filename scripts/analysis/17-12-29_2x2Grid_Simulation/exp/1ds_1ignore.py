...
dir_name='E:/Projects/qPAINT/data/17-12-12_Simulation2x2Grid/FS_17-12-31_1ds_1ignore'
...
f1.suptitle('Picasso Simulate: Bright times\n'+r'$\tau_b$'+'= 5 s (100 frames)\n'+
            '1 docking site per pick, ignore = 1')
...
for i in range(0,4):
    ...
    axarr[i,3].text(x_text+100,y_text,'%d (%d)'%(length_cdf_mean,length_cdf_std))
