...
file_names=['taub2s_kon2e6_n24_c5nM_locs_picked_groupprops.hdf5']
file_names.extend(['taub2s_kon2e6_n24_c10nM_locs_picked_groupprops.hdf5'])
file_names.extend(['taub2s_kon2e6_n24_c20nM_locs_picked_groupprops.hdf5'])
file_names.extend(['taub2s_kon2e6_n24_c50nM_locs_picked_groupprops.hdf5'])
file_names.extend(['taub2s_kon2e6_n24_c100nM_locs_picked_groupprops.hdf5'])
# Define labels
labels=['5nM']
labels.extend(['10nM'])
labels.extend(['20nM'])
