...
############################################################## Define data
dir_names=[]
dir_names.extend(['/fs/pool/pool-schwille-paint/Data/p04.lb-FCS/19-05-29_Streptavidin/04_5nM_p35uW_1/19-05-29_JS/']*1)

file_names=[]
file_names.extend(['04_5nM_p35uW_1_MMStack_Pos0.ome_locs_render_picked.hdf5'])
#file_names.extend(['03_10nM_p35uW_1_MMStack_Pos1.ome_locs_render_picked.hdf5'])
